                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>update</h3>
                                <small><strong>Please enter your data to update.</strong></small>                            </div>
                        </div>
                    </div>
                        ...
                        <form action="dbOperationModule.php" method="get" novalidate>
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <span class="help-block small"> update Your email address to contact</span>						</div>
								<div class="form-group col-lg-6">
                                    <label>Phone Number</label>
                                    <input type="number" value="" id="Phone" class="form-control" name="Phone_number">
                                    <span class="help-block small">update Your address Phone number to contact</span>				</div>
								<div class="form-group col-lg-6">
                                    <label>update Address</label>
                                    <input type="text" value="" id="Address" class="form-control" name="Address">
                                    <span class="help-block small">update Your address to contact</span>							</div>
								<div class="form-group col-lg-6">
                                    <label>City</label>
                                    <input type="text" value="" id="city" class="form-control" name="City">
                                    <span class="help-block small"> update Your city</span>											</div>
								<div class="form-group col-lg-6">
                                    <label>Pin code</label>
                                    <input type="text" value="" id="pincode" class="form-control" name="Pincode">
                                    <span class="help-block small"> update Your zipcode(pin code)</span>							</div>
								<div class="form-group col-lg-6">
                                    <label>state</label>
                                   ...
                                   <!--<input type="text" value="" id="state" class="form-control" name="state"> -->
                                    <span class="help-block small">choose your state to update</span> 								</div>     
                            </div>
							
                            <div>
								
								<input class="btn btn-warning" type="submit" value="update" name="updateProfile">
